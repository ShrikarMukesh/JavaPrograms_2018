...
public class ArrayStructures {
	...
	public static void main(String[] args) {
		ArrayStructures p = new ArrayStructures();
		p.generateRandomArray();
		p.printArray();
		System.out.println(p.getValueAtIndex(3));
		...
		System.out.println(p.linearSearchForValue(45));
		System.out.println("descending arder");
		p.bubbleSortDescending();
		p.printArray();
		System.out.println("binary search");
		p.binarySearchForValue(12);
		p.printArray();
